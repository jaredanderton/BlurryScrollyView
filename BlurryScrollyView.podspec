...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BlurryScrollyView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jared Anderton/BlurryScrollyView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jared Anderton' => 'jared@andertondev.com' }
  s.source           = { :git => 'https://github.com/Jared Anderton/BlurryScrollyView.git', :tag => s.version.to_s }
